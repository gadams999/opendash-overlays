...
namespace OpenDash.DiscordChatOverlay.Tests.ViewModels;

public class OverlayViewModelTests
{
    // Feature: Discord Chat Overlay, Property 1: speaker cap never exceeds 8 items regardless of event count
#if FAST_TESTS
    [Property(MaxTest = 10)]
#else
    ...
    // Feature: Discord Chat Overlay, Property 2: display list never exceeds 8 items in all-members mode
#if FAST_TESTS
    [Property(MaxTest = 10)]
#else
    [Property(MaxTest = 100)]
