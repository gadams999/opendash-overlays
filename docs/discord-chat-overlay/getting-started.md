...
description: "Install Discord Chat Overlay, authorize with Discord, and start using the overlay"
---
...
1. Download `DiscordChatOverlay-v0.1.0.msi` from the [GitHub Releases](https://github.com/gavincadams/opendash-overlays/releases) page
2. Run the installer — it will install to `%ProgramFiles%\OpenDash\DiscordChatOverlay\`
...
Alternatively, revoke access inside Discord (**User Settings → Authorized Apps → DiscordChatOverlay → Deauthorize**) — the app will detect the revocation and update the tray icon to red.
