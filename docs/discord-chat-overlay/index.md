...
Discord Chat Overlay is a lightweight Windows desktop application that displays an always-on-top, click-through overlay showing active speakers in your current Discord voice channel in real time.
