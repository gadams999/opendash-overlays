...
description: "Common Discord Chat Overlay errors and how to resolve them"
---
...
The app stores its OAuth token under the name `DiscordChatOverlay` in Windows Credential Manager.

To inspect or manually delete it:

1. Open **Control Panel → Credential Manager → Windows Credentials**
2. Look for an entry named `DiscordChatOverlay`
