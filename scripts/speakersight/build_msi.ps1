# Complete Build Script for SpeakerSight MSI
...
Write-Host "=== SpeakerSight MSI Build Script ===" -ForegroundColor Cyan
Write-Host ""
...
$packageDir = ".\Package"
$installerDir = ".\installers\speakersight"
$assetsDir = ".\assets\speakersight"
...
Write-Host "  msiexec /i Package\SpeakerSight-v0.1.0.msi" -ForegroundColor White
Write-Host ""
Pop-Location
